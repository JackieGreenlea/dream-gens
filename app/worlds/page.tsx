    ...
    <main className="mx-auto min-h-screen max-w-6xl px-6 py-10 sm:px-8 lg:px-10">
      <div className="space-y-6">
        <Card className="space-y-3">
          <p className="text-sm uppercase tracking-[0.24em] text-gold">My Worlds</p>
          <h1 className="text-3xl font-semibold text-white">Your saved worlds</h1>
        ...
        {worlds.length === 0 ? (
          <Card className="space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold text-white">No worlds yet</h2>
            ...
            {worlds.map((world) => (
              ...
              >
                <div className="space-y-2">
                  ...
                  <h2 className="text-2xl font-semibold text-white">{world.title}</h2>
                  <p className="max-w-3xl text-sm leading-6 text-mist">{world.shortSummary}</p>
                </div>
